...
if (!function_exists('getPageList')) {
    ...
    function getModules($module = null)
    {
        $array_list = [
            ...
            'COMPETITION','COMPETITIONPAPER','COMPETITION_ASSIGN','COMPETITION_RESULT_UPLOAD','COURSE','EXTERNAL_CENTRE_ACCOUNT','GRADING_EXAM','GRADING_PAPER','GRADING_ASSIGN','GRADING_RESULT_UPLOAD','STUDENT_REPORTS','TEACHING_MATERIALS',
