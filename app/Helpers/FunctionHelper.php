...
if (!function_exists('getPageList')) {
    ...
    function getModules($module = null)
    {
        $array_list = [
            ...
            'COMPETITION','COMPETITIONPAPER','COURSE','EXTERNAL_CENTRE_ACCOUNT','GRADE','GRADING_EXAM','GRADING_PAPER','REPORTS','TEACHING_MATERIALS',
            'TEST_ALLOCATION','TEST_MANAGEMENT','TEST_PAPER','COMPETITIONQUESTIONS','COMPETITION_RESULT','SURVEY','SURVEY_QUESTIONS','SURVEY_QUESTIONS_OPTIONS',
            'SURVEY_ALLOCATION','STANDALONE_PAGE','QUESTIONS_ATTEMPT','ORDERS','ACHIEVEMENT'
