...
if (!function_exists('getPageList')) {
    ...
    function getModules($module = null)
    {
        $array_list = [
            ...
            'COMPETITION','COMPETITIONPAPER','COMPETITION_ASSIGN','COMPETITION_RESULT_UPLOAD','COURSE','EXTERNAL_CENTRE_ACCOUNT','GRADE','GRADING_EXAM','GRADING_PAPER','REPORTS','TEACHING_MATERIALS',
            ...
            'SURVEY_ALLOCATION','STANDALONE_PAGE','QUESTIONS_ATTEMPT','ORDERS','ACHIEVEMENT', 'IMAGEUPLOAD'
