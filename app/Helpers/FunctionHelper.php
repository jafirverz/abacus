...
if (!function_exists('getPageList')) {
    ...
    function getModules($module = null)
    {
        $array_list = [
            ...
            'SURVEY_ALLOCATION','STANDALONE_PAGE','QUESTIONS_ATTEMPT','ORDERS','ACHIEVEMENT', 'IMAGEUPLOAD','SALES_REPORTS','ONLINESTUDENT_REPORTS','INSTRUCTOR_REPORTS','WORKSHEET_REPORTS'
