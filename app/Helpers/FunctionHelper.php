...
if (!function_exists('getPageList')) {
    ...
    function getQuestionTemplate($id = null)
    {
        ...
        $array_list = ['1'  =>  'Listening Questions', '2'  =>  'Visual Flashing Questions' , '3' => 'Number Questions', '4' => 'Add and subtract Questions', '5' => 'Multiply and Divide Questions', '6' => 'Challenge Questions', '7' => 'Mixed Questions', '8' => 'Abacus simulator Questions', '11' => 'Learning Videos'];
        if ($id) {
            return $array_list[$id];
        }
        return $array_list;
    ...
    function getModules($module = null)
    {
        $array_list = [
            ...
            'BANNER_MANAGEMENT','QUESTION_MANAGEMENT','TOPIC','LEVEL','WORKSHEET','ANNOUNCEMENT','CATEGORY_COMPETITION','CERTIFICATE',
            'COMPETITION','COMPETITIONPAPER','COMPETITION_ASSIGN','COMPETITION_RESULT_UPLOAD','COURSE','EXTERNAL_CENTRE_ACCOUNT','GRADE','GRADING_EXAM','GRADING_PAPER','STUDENT_REPORTS','TEACHING_MATERIALS',
            ...
            'SURVEY_ALLOCATION','STANDALONE_PAGE','QUESTIONS_ATTEMPT','ORDERS','ACHIEVEMENT', 'IMAGEUPLOAD','SALES_REPORTS','ONLINESTUDENT_REPORTS','INSTRUCTOR_REPORTS','WORKSHEET_REPORTS', 'EXTERNAL_CENTRE_REPORT', 'COMPETITION_REPORTS'
