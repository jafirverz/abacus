...
class GradingQuestionsController extends Controller
{
    ...
    public function index()
    {
        //
        $title = $this->title;
        // $competitionQuestions = GradingPaperQuestion::with('comp_paper')->groupBy('grading_paper_id')->paginate($this->pagination);
        $competitionPaper = GradingPaper::whereHas('comp_ques')->paginate($this->pagination);
    ...
    public function create()
    {
        //
        $title = $this->title;
        $papers = GradingPaper::orderBy('id', 'desc')->get();
    ...
    public function edit($id)
    {
        ...
        $compQues = GradingPaperQuestion::where('grading_paper_id', $id)->get();
    ...
    public function destroy(Request $request)
    {
        ...
        $ids = explode(',', $ids);
        $compQues = GradingPaperQuestion::whereIn('grading_paper_id', $ids)->get();
    ...
    public function search(Request $request)
    {
        ...
        $title = $this->title;
        $competitionPaper = GradingPaper::whereHas('comp_ques')->search($search_term)->paginate($this->pagination);
        if ($search_term) {
