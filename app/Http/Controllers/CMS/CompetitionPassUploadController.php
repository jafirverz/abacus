...
use Excel;
use App\Imports\ImportCompetitionPass;

class CompetitionPassUploadController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->title = __('constant.COMPEITION_PASS_UPLOAD');
        $this->module = 'COMPEITION_PASS_UPLOAD';
    ...
    {
        //
        $title = 'Upload Competition Pass';
        $competition = Competition::where('competition_type', 'physical')->where('status', 1)->get();
        return view('admin.competition.pass-upload', compact('title', 'competition'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('fileupload')) {
            ...
            $imported_files[] = "Competition Pass Upload";
