...
class LoanController extends Controller
{
  ...
  public function authorise(Request $request)
  {
    ...
    $params = [
      ...
      'redirect_uri'  => 'https://www.diycars.com/car-loan/callback',
      'client_id'     => 'PROD-200501881C-AUTOLINK-CARLOAN',
      'client_secret' => 'CFSt3UpVoOxxJ9N1hJ16Yyxtv3hH1wLr',
      'code'          => $code,
      'state'          => $state,
    ];
    ...
    $authHeaders = $this->generateSHA256withRSAHeader(
      ...
      'PROD-200501881C-AUTOLINK-CARLOAN',
      'CFSt3UpVoOxxJ9N1hJ16Yyxtv3hH1wLr'
    );
    ...
    $userDetails['cpfhistory'] = $details['cpfcontributions']['history'] ?? '';
    $userDetails['noahistory'] = $details['noahistory']['noas'] ?? '';
    ...
    if(!Session::get('myinfoloan')){
      Session::put('myinfoloan', $userDetails);
    }else{
