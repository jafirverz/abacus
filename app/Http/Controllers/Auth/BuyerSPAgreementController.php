...
class BuyerSPAgreementController extends Controller
{
  ...
  public function authorise(Request $request)
  {
    ...
    $params = [
      ...
      'redirect_uri'  => 'https://www.diycars.com/buyer-sales-purchase/callback',
      'client_id'     => 'PROD-200501881C-AUTOLINK-BUYERSALESPURCH',
      'client_secret' => 'rdY15ePc713DwgrvqxKUqvjmc4sj0RFk',
      'code'          => $code,
      'state'          => $state,
    ];
    ...
    $authHeaders = $this->generateSHA256withRSAHeader(
      ...
      'PROD-200501881C-AUTOLINK-BUYERSALESPURCH',
      'rdY15ePc713DwgrvqxKUqvjmc4sj0RFk'
    );
    ...
    if(!Session::get('myinfobuyersp')){
      Session::put('myinfobuyersp', $userDetails);
    }else{
      Session::forget('myinfobuyersp');
      Session::put('myinfobuyersp', $userDetails);
    }
    // Session::forget('myinfoquotebusiness');
    // dd($userDetails);
    // return redirect()->back();
    $returnUrl = Session::get('buyerspurl');
  ...
  public function createPersonRequest($userUniFin, $jwtAccessToken)
  {
    ...
    $params = [
      'attributes' => 'uinfin,name,sex,mobileno,email,regadd',
      'client_id' => 'PROD-200501881C-AUTOLINK-BUYERSALESPURCH'
    ];
