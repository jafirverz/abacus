...
class AdvertiseMyCarBusinessController extends Controller
{
  ...
  public function authorise(Request $request)
  {
    ...
    $params = [
      ...
      'redirect_uri'  => 'https://www.diycars.com/mib-advertise-car/callback',
      'client_id'     => 'PROD-200501881C-AUTOLINK-MIB-ADVERTISECAR',
      'client_secret' => 'Aya7Uee0GOyhYfwx4xCJoHyIwdreGJXl',
      'code'          => $code,
      'state'          => $state,
    ];
    ...
    $authHeaders = $this->generateSHA256withRSAHeader(
      ...
      'PROD-200501881C-AUTOLINK-MIB-ADVERTISECAR',
      'Aya7Uee0GOyhYfwx4xCJoHyIwdreGJXl'
    );
    ...
    if(!Session::get('myinfoadvertisebusiness')){
      Session::put('myinfoadvertisebusiness', $userDetails);
    }else{
