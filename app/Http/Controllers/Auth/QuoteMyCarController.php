...
class QuoteMyCarController extends Controller
{
  ...
  public function authorise(Request $request)
  {
    ...
    $params = [
      ...
      'redirect_uri'  => 'https://www.diycars.com/quote-my-car/callback',
      'client_id'     => 'PROD-200501881C-AUTOLINK-QUOTEMYCAR',
      'client_secret' => '6xdh21I1WZ5DIOKJmM70V2IjyYYJ24WA',
      'code'          => $code,
      'state'          => $state,
    ];
    ...
    $authHeaders = $this->generateSHA256withRSAHeader(
      ...
      'PROD-200501881C-AUTOLINK-QUOTEMYCAR',
      '6xdh21I1WZ5DIOKJmM70V2IjyYYJ24WA'
    );
    ...
    if(!Session::get('myinfoquotemycar')){
      Session::put('myinfoquotemycar', $userDetails);
    }else{
