...
class QuoteMyCarBusinessController extends Controller
{
  ...
  public function authorise(Request $request)
  {
    ...
    $params = [
      ...
      'redirect_uri'  => 'https://www.diycars.com/mib-quote-my-car/callback',
      'client_id'     => 'PROD-200501881C-AUTOLINK-MIB-QUOTEMYCAR',
      'client_secret' => 'aLPW0oi90mJe4AuivgqsrWGWPtzLOM4y',
      'code'          => $code,
      'state'          => $state,
    ];
    ...
    $authHeaders = $this->generateSHA256withRSAHeader(
      ...
      'PROD-200501881C-AUTOLINK-MIB-QUOTEMYCAR',
      'aLPW0oi90mJe4AuivgqsrWGWPtzLOM4y'
    );
    ...
    if(!Session::get('myinfoquotebusiness')){
      Session::put('myinfoquotebusiness', $userDetails);
    }else{
      Session::forget('myinfoquotebusiness');
      Session::put('myinfoquotebusiness', $userDetails);
    }
    Session::forget('myinfoquotemycar');
    // dd($userDetails);
    // return redirect()->back();
    return redirect('/quote-my-car-form');
    // dd($details);
    // dd($response->getBody()->getContents());
    // dd($response);
  ...
  public function createPersonRequest($uen, $uinfin, $jwtAccessToken)
  {
    ...
    $params = [
      'attributes' => 'name,sex,email,mobileno',
      'client_id' => 'PROD-200501881C-AUTOLINK-MIB-QUOTEMYCAR'
    ];
