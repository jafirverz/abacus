...
class AccountRegistrationController extends Controller
{
  ...
  public function authorise(Request $request)
  {
    ...
    $params = [
      ...
      'redirect_uri'  => 'https://www.diycars.com/acc-reg/callback',
      'client_id'     => 'PROD-200501881C-AUTOLINK-ACCTREG',
      'client_secret' => 'bvBeroWl6nSOu0xDvdisBksA247KrkmC',
      'code'          => $code,
      'state'          => $state,
    ];
    ...
    $authHeaders = $this->generateSHA256withRSAHeader(
      ...
      'PROD-200501881C-AUTOLINK-ACCTREG',
      'bvBeroWl6nSOu0xDvdisBksA247KrkmC'
    );
    ...
    if(!Session::get('myinfosignup')){
      Session::put('myinfosignup', $userDetails);
    }else{
      Session::forget('myinfosignup');
      Session::put('myinfosignup', $userDetails);
    }
  ...
  public function createPersonRequest($userUniFin, $jwtAccessToken)
  {
    ...
    $params = [
      'attributes' => 'name,mobileno,email,sex',
      'client_id' => 'PROD-200501881C-AUTOLINK-ACCTREG'
    ];
