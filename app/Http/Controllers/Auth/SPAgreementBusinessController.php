...
class SPAgreementBusinessController extends Controller
{
  ...
  public function authorise(Request $request)
  {
    ...
    $params = [
      ...
      'redirect_uri'  => 'https://www.diycars.com/mib-seller-sales-purchase/callback',
      'client_id'     => 'PROD-200501881C-AUTOLINK-MIB-SELLERSALESPURCH',
      'client_secret' => 'wnkhnde2TUEq7KKPZ8ccdyOtYpzJB6EK',
      'code'          => $code,
      'state'          => $state,
    ];
    ...
    $authHeaders = $this->generateSHA256withRSAHeader(
      ...
      'PROD-200501881C-AUTOLINK-MIB-SELLERSALESPURCH',
      'wnkhnde2TUEq7KKPZ8ccdyOtYpzJB6EK'
    );
    ...
    if(!Session::get('myinfospbusiness')){
      Session::put('myinfospbusiness', $userDetails);
    }else{
  ...
  public function createPersonRequest($uen, $uinfin, $jwtAccessToken)
  {
    ...
    $params = [
      'attributes' => 'uinfin,name,sex,email,mobileno',
      'client_id' => 'PROD-200501881C-AUTOLINK-MIB-SELLERSALESPURCH'
    ];
