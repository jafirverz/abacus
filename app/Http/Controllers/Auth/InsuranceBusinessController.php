...
class InsuranceBusinessController extends Controller
{
  ...
  public function authorise(Request $request)
  {
    ...
    $params = [
      ...
      'redirect_uri'  => 'https://www.diycars.com/mib-car-insurance/callback',
      'client_id'     => 'PROD-200501881C-AUTOLINK-MIB-CARINSURANCE',
      'client_secret' => 'B42tU2pJ4RxdkoFK0U1DkDwbHt8Oxgmp',
      'code'          => $code,
      'state'          => $state,
    ];
    ...
    $authHeaders = $this->generateSHA256withRSAHeader(
      ...
      'PROD-200501881C-AUTOLINK-MIB-CARINSURANCE',
      'B42tU2pJ4RxdkoFK0U1DkDwbHt8Oxgmp'
    );
    ...
    if(!Session::get('myinfoinsurancebusiness')){
      Session::put('myinfoinsurancebusiness', $userDetails);
    }else{
  ...
  {
    // $uinfin = 'S6005052Z';
    // $url = 'https://api.myinfo.gov.sg/biz/v2/entity-person/{uen}/{uinfin}/';
    $url = 'https://api.myinfo.gov.sg/biz/v2/entity-person/'.$uen.'/'.$uinfin.'/';
    // $url            = config('myinfo.api.personal') . '/' . $userUniFin . '/';
    $params = [
      'attributes' => 'uinfin,name,sex,nationality,dob,email,mobileno,regadd,marital',
      'client_id' => 'PROD-200501881C-AUTOLINK-MIB-CARINSURANCE'
    ];
