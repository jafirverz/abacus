...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            ...
            <h1>{{ $title ?? '-' }}</h1>
            @include('admin.inc.breadcrumb', ['breadcrumbs' => Breadcrumbs::generate('admin_chat_window_crud', 'Create', route('chat-window.create'))])
        </div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('chat-window.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="card-body">
                                ...
                                <div class="">
                                <input class="form-control" placeholder="" value="{{  old('title') }}" name="title" type="text">                                   @if ($errors->has('partner_name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        ...
                                        <small class="text-muted">
                                            Icon size should be 20*20 for better resolution. Only png, jpg, and gif
