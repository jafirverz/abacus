...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            ...
            @include('admin.inc.breadcrumb', ['breadcrumbs' => Breadcrumbs::generate('admin_contact')])
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <a href="{{ route('contact.destroy', 'contact') }}" class="btn btn-danger d-none destroy"
                            ...
                            <form id="destroy" action="{{ route('contact.destroy', 'contact') }}" method="post">
                                @csrf
                                @method('DELETE')
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php /*?><a href="{{ route('contact.edit', $item->id) }}"
                                                    class="btn btn-light mr-1 mt-1" data-toggle="tooltip"
                                                    data-original-title="Edit"><i class="fas fa-edit"></i></a><?php */?>
                                            </td>
                                            <td>{{ $item->full_name }}</td>
                                            <td>{{ $item->email_id }}</td>
                                            <td>{{ $item->mobilewithcountrycode ?? '' }}</td>
                                            <td>{{ $item->message }}</td>
