            ...
            <div class="row">
                ...
                @endif
                            ...
                            <div id="section2" class="@if(is_null(old('named_driver',$insurance->named_driver))) hide @elseif(old("named_driver",$insurance->named_driver)==2) hide @else  @endif">
                                ...
                                <div class="form-group">
                                    ...
                                    <select @if($insurance->quotation_id!=null) disabled="disabled" @endif class="form-control" name="driver_gender" id="driver_gender">
                                        <option @if(old('main_driver_gender',$insurance->driver_gender)=="Male") selected="selected" @endif value="Male">Male</option>
                                        <option @if(old('main_driver_gender',$insurance->driver_gender)=="Female") selected="selected" @endif value="Female">Female</option>
                                    </select>
                                    @if($insurance->quotation_id!=null)
						...
						<div class="form-group">
							...
							<input @if($insurance->quotation_id!=null) readonly="readonly" @endif type="text" class="form-control" placeholder="Example: Toyota Altis 1.6A" name="make_model" id="make_model" value="{{old('make_model',$insurance->make_model)}}" required="required"  />
						...
						<div class="form-group">
							...
							<input @if($insurance->quotation_id!=null) readonly="readonly" @endif type="text" class="form-control" placeholder="Example: 1598" name="engine_capacity" id="engine_capacity" value="{{old('engine_capacity',$engineCapacity)}}" required="required" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"  />
						...
						<div class="form-group">
							...
							<input @if($insurance->quotation_id!=null) readonly="readonly" @endif type="text" class="form-control datepicker547" placeholder="Example: 1598" name="date_of_registration" id="date_of_registration" value="{{old('date_of_registration', date('d-m-Y', strtotime($insurance->date_of_registration)))}}" required="required"  />
						...
						<div class="form-group">
							...
							<input minlength="4" maxlength="4" @if($insurance->quotation_id!=null) readonly="readonly" @endif type="text" class="form-control positive-integer" placeholder="Example: 1598"  name="year_of_manufacture" id="year_of_manufacture" value="{{old('year_of_manufacture',$insurance->year_of_manufacture)}}" required="required" />
                        ...
                        <div class="form-group">
							...
							<input @if($insurance->quotation_id!=null) readonly="readonly" @endif type="text" class="form-control" placeholder="" name="vehicle_engine_number" id="vehicle_engine_number" value="{{old('vehicle_engine_number',$insurance->vehicle_engine_number)}}" required="required" />
                        ...
                        <div class="form-group">
                            ...
                            <input @if($insurance->quotation_id!=null) readonly="readonly" @endif type="text" class="form-control" name="previous_vehicle_number" id="previous_vehicle_number" value="{{old('previous_vehicle_number',$insurance->previous_vehicle_number)}}" />
                  ...
                  @if($quotations)
                   ...
                   <!--If quotation not accepted-->
                     ...
                     <div class="col-12"><div class="form-group"><label>Premium </label><input type="text" class="form-control" name="premium[]" id="premium" value="<?=$quotation->premium?>" /></div></div>
                     <div class="col-12"><div class="form-group"><label>Excess: Own damage </label><input type="text" class="form-control" name="excess_own_damage[]" id="excess_own_damage" value="<?=$quotation->excess_own_damage?>" /></div></div>
                     <div class="col-12"><div class="form-group"><label>Excess: 3rd Party  </label><input type="text" class="form-control" name="excess_party[]" id="excess_party" value="<?=$quotation->excess_party?>" /></div></div>
