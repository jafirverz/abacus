...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            ...
            @include('admin.inc.breadcrumb', ['breadcrumbs' => Breadcrumbs::generate('admin_faq')])
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <a href="{{ route('faqs.destroy', 'faqs') }}" class="btn btn-danger d-none destroy"
                            ...
                            <form id="destroy" action="{{ route('faqs.destroy', 'faqs') }}" method="post">
                                @csrf
                                @method('DELETE')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div
                                                    ...
                                                    {{ getActiveStatus($item->status) }}</div>
                                                @endif
                                            </td>
                        ...
                        <div class="card-footer">
                            @if(request()->get('_token'))
                            {{ $faqs->appends(['_token' => request()->get('_token'),'search' => request()->get('search') ])->links() }}
                            @else
                            {{ $faqs->links() }}
                            @endif
                        </div>
