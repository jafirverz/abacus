    ...
    <section class="section">
        <div class="section-header">
           ...
           <div class="section-header-button">
                <a href="{{ route('options-survey-questions.create') }}" class="btn btn-primary">Add New</a>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('options-survey-questions.destroy', 'options-survey-questions') }}"
                    ...
                    <form id="destroy" action="{{ route('options-survey-questions.destroy', 'options-survey-questions') }}"
                        method="post">
                        @csrf
                        @method('DELETE')
                    ...
                    <div class="card-header-form form-inline">
                        <form action="{{ route('options-survey-questions.search') }}" method="get">
                            @csrf
                        ...
                        <table class="table table-md">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('options-survey-questions.show', $item->id) }}"
                                            class="btn btn-info mr-1 mt-1" data-toggle="tooltip"
                                            data-original-title="View"><i class="fas fa-eye"></i></a>
                                        <a href="{{ route('options-survey-questions.edit', $item->id) }}"
