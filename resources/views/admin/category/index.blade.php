...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            ...
            @include('admin.inc.breadcrumb', ['breadcrumbs' => Breadcrumbs::generate('admin_categry')])
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <form id="destroy" action="{{ route('category.destroy', 'category') }}" method="post">
                                @csrf
                                @method('DELETE')
                                ...
                                <table class="table table-md">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('category.show', $item->id) }}" class="btn btn-info mr-1 mt-1" data-toggle="tooltip" data-original-title="View"><i class="fas fa-eye"></i></a>
                                                <a href="{{ route('category.edit', $item->id) }}" class="btn btn-light mr-1 mt-1" data-toggle="tooltip" data-original-title="Edit"><i class="fas fa-edit"></i></a>
                                            </td>
                                            <td>{{ $item->title }}</td>
                        ...
                        <div class="card-footer">
                            @if(request()->get('_token'))
                            {{ $categories->appends(['_token' => request()->get('_token'),'search' => request()->get('search') ])->links() 								}}
                            @else
                            {{ $categories->links() }}
                           @endif
                        </div>
