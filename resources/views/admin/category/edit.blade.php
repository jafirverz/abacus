...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            ...
            <h1>{{ $title ?? '-' }}</h1>
            @include('admin.inc.breadcrumb', ['breadcrumbs' => Breadcrumbs::generate('admin_categry_crud', 'Edit', route('category.edit', $category->id))])
        </div>
                        ...
                        <form action="{{ route('category.update', $category->id) }}" method="post">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="view_order" class="form-control" id="" value="{{ old('view_order', $category->view_order) }}" min="0">
