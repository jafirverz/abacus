    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-button">
                <a href="{{ route('lesson-questions.create') }}" class="btn btn-primary">Add New</a>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <a href="{{ route('lesson-questions.destroy', 'lesson-questions') }}" class="btn btn-danger d-none destroy"
                            ...
                            <form id="destroy" action="{{ route('lesson-questions.destroy', 'lesson-questions') }}" method="post">
                                @csrf
                                @method('DELETE')
                            ...
                            <div class="card-header-form form-inline">
                                <form action="{{ route('lesson-questions.search') }}" method="get">
                                    @csrf
