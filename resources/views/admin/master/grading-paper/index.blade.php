                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <a href="{{ route('grading-paper.destroy', 'papers') }}" class="btn btn-danger d-none destroy"
                            ...
                            <form id="destroy" action="{{ route('grading-paper.destroy', 'competition') }}" method="post">
                                @csrf
                                @method('DELETE')
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('grading-paper.questions', $item->id) }}"
                                                    class="btn btn-light mr-1 mt-1" data-toggle="tooltip"
