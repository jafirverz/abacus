...
{{--            @include('admin.inc.breadcrumb', ['breadcrumbs' => Breadcrumbs::generate('admin_bank_crud', 'Create', route('bank.create'))])--}}
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('grade-questions.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    @endif
                                    @if(isset($qId) && $qId==7)
                                    <input type="hidden" name="template" value="@if(isset($_GET['template'])) {{ $_GET['template'] }} @else{{1}}@endif">
                                    @endif
                                </div>
                                @endif
                                @php
