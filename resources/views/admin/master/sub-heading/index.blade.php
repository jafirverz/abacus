    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-button">
                <a href="{{ route('sub-heading.create') }}" class="btn btn-primary">Add New</a>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <a href="{{ route('sub-heading.destroy', 'sub-heading') }}" class="btn btn-danger d-none destroy"
                            ...
                            <form id="destroy" action="{{ route('sub-heading.destroy', 'sub-heading') }}" method="post">
                                @csrf
                                @method('DELETE')
                            ...
                            <div class="card-header-form form-inline">
                                <form action="{{ route('sub-heading.search') }}" method="get">
                                    @csrf
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('sub-heading.edit', $item->id) }}"
