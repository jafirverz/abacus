...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            ...
            <h1>{{ $title ?? '-' }}</h1>
          @include('admin.inc.breadcrumb', ['breadcrumbs' => Breadcrumbs::generate('category_grading_crud', 'Edit', route('category-grading.edit', $category->id))])
        </div>
        ...
        <div class="section-body">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('category-grading.update', $category->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="grade_type_id" class="form-control">
                                        ...
                                        <option value="{{ $item->id }}" @if(old('grade_type_id',$category->grade_type_id)==$item->id)
                                            selected
