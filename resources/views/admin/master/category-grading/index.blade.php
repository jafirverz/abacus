    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-button">
                <a href="{{ route('category-grading.create') }}" class="btn btn-primary">Add New</a>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <a href="{{ route('category-grading.destroy', 'category-grading') }}" class="btn btn-danger d-none destroy"
                            ...
                            <form id="destroy" action="{{ route('category-grading.destroy', 'category-grading') }}" method="post">
                                @csrf
                                @method('DELETE')
                            ...
                            <div class="card-header-form form-inline">
                                <form action="{{ route('category-grading.search') }}" method="get">
                                    @csrf
