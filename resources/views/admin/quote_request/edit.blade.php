...
@section('content')<style>.licon { position: relative; }.licon .ltext { align-items: center; bottom: 0; left: 0; line-height: 42px; position: absolute; text-align: center; top: 0; width: 40px; }.licon .form-control { padding-left: 40px !important; }</style>
<!-- Main Content -->
<div class="main-content">
    <section class="section">
        <div class="section-header">
            ...
            <h1>{{ $title ?? '-' }}</h1>
            @include('admin.inc.breadcrumb', ['breadcrumbs' => Breadcrumbs::generate('admin_car_quoterequest_crud', 'Edit', route('quoterequest.edit', $quote_request->id))])
        </div>
...
<script>
    $(function () {
        $("#open_market_value,#minimumparfbenefit,#quota_premium,#max_unladen_weight,#quote_price, #mileage,#engine_capacity").on('keyup', function () {
