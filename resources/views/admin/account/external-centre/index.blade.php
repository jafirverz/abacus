    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-button">
                <a href="{{ route('external-centre-account.create') }}" class="btn btn-primary">Add New</a>
        </div>
        @include('admin.inc.breadcrumb', ['breadcrumbs' => Breadcrumbs::generate('external_centre_account')])
</div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('external-centre-account.destroy', 'external-centre-account') }}"
                    ...
                    <form id="destroy" action="{{ route('external-centre-account.destroy', 'external-centre-account') }}"
                        method="post">
                        @csrf
                        @method('DELETE')
                    ...
                    <div class="card-header-form form-inline">
                        <form action="{{ route('external-centre-account.search') }}" method="get">
                            @csrf
                        ...
                        <table class="table table-md">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('external-centre-account.show', $item->id) }}"
                                            class="btn btn-info mr-1 mt-1" data-toggle="tooltip"
                                            data-original-title="View"><i class="fas fa-eye"></i></a>
                                        <a href="{{ route('external-centre-account.edit', $item->id) }}"
