    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-button">
                <a href="{{ route('teaching-materials.create') }}" class="btn btn-primary">Add New</a>
            </div>
            @include('admin.inc.breadcrumb', ['breadcrumbs' => Breadcrumbs::generate('admin_teaching_materials')])
                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-header-form form-inline">
                                <form action="{{ route('teaching-materials.search') }}" method="get">
                                    @csrf
                        ...
                        <div class="card-footer">
                            @if(request()->get('_token'))
                            {{ $materials->appends(['_token' => request()->get('_token'),'search' => request()->get('search') ])->links() }}
                            @else
                            {{ $materials->links() }}
                           @endif
                        </div>
