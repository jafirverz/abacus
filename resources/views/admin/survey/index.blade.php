    ...
    <section class="section">
        <div class="section-header">
           ...
           <div class="section-header-button">
                <a href="{{ route('survey.create') }}" class="btn btn-primary">Add New</a>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('survey.destroy', 'survey') }}"
                    ...
                    <form id="destroy" action="{{ route('survey.destroy', 'survey') }}"
                        method="post">
                        @csrf
                        @method('DELETE')
                    ...
                    <div class="card-header-form form-inline">
                        <form action="{{ route('survey.search') }}" method="get">
                            @csrf
                        ...
                        <table class="table table-md">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('survey.show', $item->id) }}"
