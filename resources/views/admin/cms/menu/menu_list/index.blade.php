    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-button">
                <a href="{{ route('menu-list.create', $menu) }}" class="btn btn-primary">Add New</a>
            </div>
            @include('admin.inc.breadcrumb', ['breadcrumbs' => Breadcrumbs::generate('admin_menu_list', $menu)])
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-form form-inline">
                                <form action="{{ route('menu-list.search', $menu) }}" method="get">
                                    @csrf
                                ...
                                <table class="table table-md">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('menu-list.show', ['menu' => $menu, 'id' => $item->id]) }}" class="btn btn-info mr-1 mt-1" data-toggle="tooltip" data-original-title="View"><i class="fas fa-eye"></i></a>
                                                <a href="{{ route('menu-list.edit', ['menu' => $menu, 'id' => $item->id]) }}" class="btn btn-light mr-1 mt-1" data-toggle="tooltip" data-original-title="Edit"><i class="fas fa-edit"></i></a>
                                            </td>
                                            <td>{{ $item->title }}</td>
                        ...
                        <div class="card-footer">
                            @if(request()->get('_token'))
                            {{ $menu_list->appends(['_token' => request()->get('_token'),'search' => request()->get('search') ])->links() }}
                        @else
                            {{ $menu_list->links() }}
                        @endif
                        </div>
