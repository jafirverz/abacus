    ...
    <section class="section">
        <div class="section-header">
            ...
            {{-- <div class="section-header-button">
                <a href="{{ route('pass.create') }}" class="btn btn-primary">Add New</a>
            </div> --}}
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            {{-- <div class="card-header-form form-inline">
                                <form action="{{ route('pass.search') }}" method="get">
                                    @csrf
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           {{--  <td scope="row">
                                            ...
                                            <td>
                                                <a href="{{ route('pass.show', $item->id) }}" class="btn btn-info mr-1 mt-1" data-toggle="tooltip" data-original-title="View"><i class="fas fa-eye"></i></a>
                                                <a href="{{ route('pass.edit', $item->id) }}" class="btn btn-light mr-1 mt-1" data-toggle="tooltip" data-original-title="Edit"><i class="fas fa-edit"></i></a>
                                            </td>
                                            <td>E-{{ $item->id }}</td>
                                            <td>{{ $item->title }}</td>
