...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            ...
            <h1>{{ $title ?? '-' }}</h1>
            @include('admin.inc.breadcrumb', ['breadcrumbs' => Breadcrumbs::generate('admin_smart_block_crud', 'Create', route('email-template.create'))])
        </div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('smart-block.store') }}" method="post">
                            @csrf
                            @method('POST')
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="header">Hedear</label>
                                    <input type="text" name="header" class="form-control" id="" value="{{ old('header') }}">
