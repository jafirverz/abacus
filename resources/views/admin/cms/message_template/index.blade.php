    ...
    <section class="section">
        <div class="section-header">
            ...
            {{-- <div class="section-header-button">
                <a href="{{ route('message-template.create') }}" class="btn btn-primary">Add New</a>
            </div> --}}
            @include('admin.inc.breadcrumb', ['breadcrumbs' => Breadcrumbs::generate('admin_message_template')])
        </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-form form-inline">
                                <form action="{{ route('message-template.search') }}" method="get">
                                    @csrf
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                           {{--  <td scope="row">
                                            ...
                                            <td>
                                                <a href="{{ route('message-template.show', $item->id) }}" class="btn btn-info mr-1 mt-1" data-toggle="tooltip" data-original-title="View"><i class="fas fa-eye"></i></a>
                                                <a href="{{ route('message-template.edit', $item->id) }}" class="btn btn-light mr-1 mt-1" data-toggle="tooltip" data-original-title="Edit"><i class="fas fa-edit"></i></a>
                                            </td>
                                            <td>M-{{ $item->id }}</td>
                                            <td>{{ $item->title }}</td>
                                            <td>
