...
<div class="main-content">
    <section class="section">
        <div class="section-header">
            ...
            <h1>{{ $title ?? '-' }}</h1>
            @include('admin.inc.breadcrumb', ['breadcrumbs' => Breadcrumbs::generate('admin_message_template_crud', 'Create', route('email-template.create'))])
        </div>
        ...
        <div class="section-body">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('message-template.store') }}" method="post">
                            @csrf
                            @method('POST')
                            <div class="card-body">
