                    ...
                    <div class="card">
                        ...
                        <div class="card-header">
                            ...
                            <div class="card-header-form form-inline">
                                <form action="{{ route('test-allocation.search') }}" method="get">
                                    @csrf
                        ...
                        <div class="card-footer">
                            @if(request()->get('_token'))
                            {{ $allocations->appends(['_token' => request()->get('_token'),'search' => request()->get('search') ])->links() 								}}
                            @else
                            {{ $allocations->links() }}
                           @endif
                        </div>
