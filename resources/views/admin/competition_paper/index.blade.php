    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-button">
                <a href="{{ route('papers.create') }}" class="btn btn-primary">Add New</a>
            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-header">
                            <a href="{{ route('papers.destroy', 'papers') }}" class="btn btn-danger d-none destroy"
                            ...
                            <form id="destroy" action="{{ route('papers.destroy', 'competition') }}" method="post">
                                @csrf
                                @method('DELETE')
