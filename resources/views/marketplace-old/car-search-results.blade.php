                                ...
                                <tr>
                                    <td>
                                        <div class="product-s-photo">
                                            ...
                                            <figure class="imgwrap"><a href="{{ '/car/'.$value->vehicle_id }}/marketplace-details"><img src="{{ url($upload_file[0]) }}" alt=""></a>
                                            </figure>
                                            @endif
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="prod-tb-price bdr"><strong>${{ $value->price ?? '' }} </strong></div>
                                    </td>
                                    <td>
                                        <div class="prod-tb-depr bdr">${{ $value->depreciation_price ?? '' }}/yr</div>
                                    </td>
                                    <td>
                                        <div class="prod-tb-reg bdr">{{ $value->year_of_mfg ?? '' }}</div>
                                    </td>
                                    <td>
                                        <div class="prod-tb-engcap bdr">{{ $value->engine_cc ?? '' }} cc</div>
                                    </td>
                                    <td>
                                        <div class="prod-tb-mil bdr">{{ $value->mileage ?? '' }}</div>
                                    </td>
                                    <td>
