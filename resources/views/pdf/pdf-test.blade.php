...
<body width="100%" style="margin: 0; padding: 0; background-color: #fff;">
	<table align="center" cellspacing="0" cellpadding="0" border="0"
		...
		<tbody>
				...
				<td>
					<table cellspacing="0" cellpadding="0" border="0" style="width: 100%;text-align: left;">
						<tbody>
							...
							<tr>
								<td colspan="2"><input disabled="disabled" type="checkbox"
										@if($insurance->terms_condition==1) checked="checked" @endif />
			...
			@if($insurance->named_driver!=1)
			<tr>
				<td style="height: 20px;" class="page-break">&nbsp;</td>
			</tr>
			@endif
			<tr>
				<td
				...
				<td style="padding: 0 0 30px;">
					...
					<table cellspacing="0" cellpadding="0" border="0" width="100%">
						<tbody>
							<tr>
								<td colspan="2"
									style="background: #f1f1f1; font-family: 'Opensans', Arial, sans-serif; font-size:24px; font-weight: bold; padding: 5px 20px;">
