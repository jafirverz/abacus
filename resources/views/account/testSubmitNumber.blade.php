                        ...
                        <div class="col-md-4 col-6 sp-col">
                          <div class="item">
                            <div class="inner">
                              ...
                              <textarea disabled="disabled" value="@if(isset($testSubmitted)) {{ getTestAnswer($testSubmitted->id,$question->id)->question_answer ?? '' }} @endif" class="form-control" cols="10" rows="3" placeholder="Answer" name="answer[{{ $question->id }}]"></textarea>
                            </div>
                          </div>
                        </div>
