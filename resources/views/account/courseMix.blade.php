                  ...
                  <table class="tb-2 tbtype-1">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="colanswer"><input @if(isset($courseSubmitted) && $courseSubmitted->is_submitted==1) disabled="disabled" @endif class="form-control" value="@if(isset($courseSubmitted)) {{ getCourseAnswer($courseSubmitted->id,$ques->id)->question_answer ?? '' }} @endif" type="number" name="answer[{{ $ques->id }}]" /></td>
                      </tr>
                      @php
                      $i++;
                      @endphp
