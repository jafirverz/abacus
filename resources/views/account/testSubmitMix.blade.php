                          ...
                          <tbody>
                            ...
                            <tfoot>
                                ...
                                <td class="coltype">
                                    <div class="row sp-col-5 inrow-1">
                                    <div class="col-auto sp-col"></div>
                                    <div class="col colanswer sp-col"><input  disabled="disabled" value="@if(isset($testSubmitted)) {{ getTestAnswer($testSubmitted->id,$question->id)->question_answer ?? '' }} @endif" style="text-align: right;"  class="form-control number-separator" type="text" name="answer[{{ $question->id }}]" /></div>
                                    </div>
                                </td>
                                @php
                                }
                    ...
                    <table class="tb-2 tbtype-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td class="colanswer"><input disabled="disabled" value="@if(isset($testSubmitted)) {{ getTestAnswer($testSubmitted->id,$ques->id)->question_answer ?? '' }} @endif"  class="form-control number-separator" type="text" name="answer[{{ $ques->id }}]" /></td>
                            </tr>
                            @php
                            $i++;
                            @endphp
