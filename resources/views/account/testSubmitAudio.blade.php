            ...
            @endphp
                <div class="row sp-col-10 grow">
                  ...
                  <div class="col sp-col">
                    <input disabled="disabled" value="@if(isset($testSubmitted)) {{ getTestAnswer($testSubmitted->id,$question->id)->question_answer ?? '' }} @endif" class="form-control" type="text" name="answer[{{ $question->id }}]" required placeholder="Answer" />
                  </div>
                </div>
            @php
            $i++;
