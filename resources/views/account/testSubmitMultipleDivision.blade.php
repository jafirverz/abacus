                        ...
                        <tbody>
                            ...
                            @foreach($paper_detail->questionsCourse as $ques)
                                ...
                                <tr>
                                    ...
                                    <td class="colanswer"><input readonly value="@if(isset($testSubmitted)) {{ getTestAnswer($testSubmitted->id,$ques->id)->question_answer ?? '' }} @endif"  class="number-separator form-control" type="text" name="answer[{{ $ques->id }}]" /></td>
                                </tr>
                                @php
                                $i++;
                                @endphp
