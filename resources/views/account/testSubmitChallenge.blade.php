                        ...
                        <thead>
                          ...
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td class="colanswer"><input disabled="disabled" value="@if(isset($testSubmitted)) {{ getTestAnswer($testSubmitted->id,$ques->id)->question_answer ?? '' }} @endif" class="number-separator form-control" name="answer[{{ $ques->id }}]" type="text" /></td>
                            </tr>
                            @php
                            $i++;
                            @endphp
