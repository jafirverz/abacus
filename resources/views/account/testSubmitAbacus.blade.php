                            ...
                            <table class="tb-2 tbtype-5">
                              ...
                              <tfoot>
                                <tr>
                                  ...
                                  @foreach($paper_detail->questionsCourse as $ques)
                                  <td class="colanswer text-center"><input disabled="disabled" value="@if(isset($testSubmitted)) {{ getTestAnswer($testSubmitted->id,$ques->id)->question_answer ?? '' }} @endif" class="form-control minwinpt-1" type="text" value="" name="answer[{{ $ques->id }}]" /></td>
                                  @endforeach
