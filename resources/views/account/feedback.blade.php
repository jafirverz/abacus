  ...
  <div class="row sp-col-0 tempt-2">
    ...
    <div class="col-lg-9 sp-col tempt-2-inner">
      <div class="tempt-2-content">
        ...
        <div>Have something you'd like to share? We'd love to hear your feedback! Kindly fill out this form and we'll
          get back to you as soon as we can</div>
                ...
                <div class="row sp-col-10">
                  <div class="col-auto sp-col">
                    <select class="selectpicker" disabled>
                      ...
                      <option value="{{ $phonecode->phonecode }}" @if($phonecode->phonecode ==
                        Auth::user()->country_code_phone) selected @endif>+ {{ $phonecode->phonecode }}</option>
                      @endforeach
                    </select>
                  </div>
