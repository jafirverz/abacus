...
Route::get('grading-examination-listing', 'ProfileController@grading_examination_listing')->name('grading-examination-listing');
Route::get('grading-examination/delete/{id?}', 'ProfileController@delete_grading')->name('grading-examination.delete');
Route::get('grading-examination/edit/{id?}/{geid?}', 'ProfileController@edit_grading')->name('grading-examination.edit');
...
Route::get('competition-pass/{id?}/{user_id?}', 'ProfileController@downloadPass')->name('competition.pass');
Route::get('grading-pass/{id?}/{user_id?}', 'ProfileController@downloadPass2')->name('grading.pass');
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::post('assign-competition/store', 'CMS\CompetitionAssignController@store')->name('assign-competition.store');
    ...
    Route::get('reports-grading-examination/search', 'CMS\GradingExamReportController@grading_examination_search')->name('reports-grading-examination.search');
    Route::get('reports-grading-examination', 'CMS\GradingExamReportController@index');
    ...
    Route::post('reports-instructor/search', 'CMS\FranchiseAdminReportController@searchInstructor')->name('reports-instructor.search');
    Route::get('reports-instructor', 'CMS\FranchiseAdminReportController@index');
    ...
    Route::get('reports-sales/search', 'CMS\SalesReportController@searchInSales')->name('reports-sales.search');
    Route::get('reports-sales', 'CMS\SalesReportController@index');
    Route::post('reports-sales', 'CMS\SalesReportController@searchSales')->name('salesexcel');

    // Route::get('reports-online-account/search', 'CMS\ReportController@searchOnline')->name('reports-online.search');
    ...
    Route::get('reports-worksheet/search', 'CMS\WorksheetReportController@searchInWorksheet')->name('reports-worksheet.search');
    Route::get('reports-worksheet', 'CMS\WorksheetReportController@index');
